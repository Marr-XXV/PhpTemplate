...
<!-- Mirrored from vihonet.pixelstrap.com/Authentication/LoginSimple by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 04 Dec 2024 03:49:15 GMT -->
<!-- Added by HTTrack -->
...
<head>
    ...
    <link rel="shortcut icon" href="<?= assets('assets/images/logo/BIGGS_LOGO.png') ?>" type="image/x-icon">
    ...
    <link id="color" rel="stylesheet" href="<?= assets('assets/css/color-3.css') ?>" media="screen">
    <!-- Responsive css-->

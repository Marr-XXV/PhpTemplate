...
document.addEventListener("htmx:afterRequest", function (event) {
  ...
  // console.log(target);
  // console.log(document.querySelector("#KPIModal .modal-dialog"));
  // console.log(target !== document.querySelector("#KPIModal .modal-dialog"));
  
  // Only close the modal if the target is not the modal itself
  if (target !== document.querySelector("#KPIModal .modal-dialog")) {
    const modal = bootstrap.Modal.getInstance(
      document.querySelector("#KPIModal")
    );
    if (modal) {
      modal.hide();
    }

// Always set to color-3 (blue light mode)
// localStorage.setItem("color", "color-3.css");

// Apply the fixed color-3 stylesheet
// console.log(base_URL + "assets/css/color-3.css");

$("#color").attr("href", base_URL + "assets/css/color-3.css");

// Set CSS custom properties for the blue theme (optional if they are in the stylesheet)
document.documentElement.style.setProperty("--theme-deafult", "#168eea"); // Primary color
document.documentElement.style.setProperty("--theme-secondary", "#90b4cd"); // Secondary color

// Ensure the body class is always light mode
